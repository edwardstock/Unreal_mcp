...
export const consolidatedToolDefinitions: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        landscapePath: commonSchemas.stringProp,
        includeEffective: commonSchemas.booleanProp,
        overriddenOnly: commonSchemas.booleanProp,
  ...
  },
  {
    ...
    category: 'authoring',
    description: 'Create materials and material functions with expressions, parameters, functions, instances, and landscape blend layers. get_material_info works on UMaterial, UMaterialFunction, and UMaterialFunctionInstance.',
    inputSchema: {
      type: 'object',
      properties: {
        action: {
