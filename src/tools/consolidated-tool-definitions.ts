...
export const consolidatedToolDefinitions: ToolDefinition[] = [
  ...
  {
    "name": "manage_asset",
    "description": "Generic, type-agnostic asset operations: list, search, import, duplicate, rename, move, delete, dependency analysis, metadata/tags, thumbnails, LODs, Nanite rebuild, validation, redirector cleanup, reports, source control, and render target creation.",
    "category": "core",
    "inputSchema": {
      "type": "object",
      "properties": {
        ...
        "assetPaths": {
          "type": "array",
          "description": "List of asset paths for batch operations (delete_assets, rename_assets, move_assets, source_control_submit_assets, etc.).",
          "items": {
            "type": "string"
          }
        },
        ...
        "classNames": {
          "type": "array",
          "description": "UClass names to filter by (e.g., 'Material', 'StaticMesh') for list_assets / search_assets.",
          "items": {
            "type": "string"
          }
        },
        "packagePaths": {
          "type": "array",
          "description": "Package paths to scope list_assets / search_assets. Empty means all paths.",
          "items": {
            "type": "string"
          }
        },
        "recursivePaths": {
          "type": "boolean",
          "description": "When true, list_assets / search_assets descends into subdirectories of packagePaths."
        },
        "recursiveClasses": {
          "type": "boolean",
          "description": "When true, list_assets / search_assets includes subclasses of classNames."
        },
        "limit": {
          "type": "number",
          "description": "Maximum number of results to return (paginated list_assets / search_assets)."
        },
        "offset": {
          "type": "number",
          "description": "Skip this many results before returning (paginated list_assets / search_assets)."
        },
        "sourcePath": {
          "type": "string",
        ...
        "prefix": {
          "type": "string",
          "description": "Prefix to prepend to asset names during batch rename."
        },
        "suffix": {
          "type": "string",
          "description": "Suffix to append to asset names during batch rename."
        },
        "searchText": {
          "type": "string",
          "description": "Substring to find in asset names during batch rename."
        },
        "replaceText": {
          "type": "string",
          "description": "Replacement text for searchText during batch rename."
        },
        "directoryPath": {
          "type": "string",
          "description": "Path to a directory."
        ...
        "width": {
          "type": "number",
          "description": "Width in pixels for create_thumbnails / create_render_targets."
        },
        "height": {
          "type": "number",
          "description": "Height in pixels for create_thumbnails / create_render_targets."
        },
        "format": {
          "type": "string",
          "description": "Format identifier: pixel format (e.g., 'RGBA16f') for create_render_targets, output format ('png'/'json'/'csv') for export/report actions."
        },
        "tag": {
          "type": "string",
          "description": "Name of the tag."
        ...
        "tags": {
          "type": "array",
          "description": "Asset tag list (string array) for set_assets_tags / find_assets_by_tag. Use 'tag' (singular) for single-tag actions.",
          "items": {
            "type": "string"
          }
        },
        "metadata": {
          "type": "object",
          "description": "Key-value metadata pairs to attach via set_assets_metadata.",
          "additionalProperties": true
        },
        "description": {
          "type": "string",
          "description": "Free-text description body for set_assets_metadata."
        },
        "maxDepth": {
          "type": "number",
          "description": "Maximum recursion depth for get_assets_dependencies / analyze_assets_graph. Zero or unset means unlimited."
        },
        "paths": {
          "type": "array",
          "description": "List of paths for bulk operations like fixup_redirectors and source_control_submit_assets.",
          "items": {
            "type": "string"
          }
        },
  ...
  },
  {
    ...
    "description": "Consolidated material authoring tool. Create materials, instances, functions, function instances, landscape/decal/post-process variants. Edit material graphs (nodes, connections, comments, named reroutes). Read and set material/function instance parameters with typed batch setters. Author function inputs/outputs and custom HLSL expressions. Compile and diagnose materials.",
    "category": "authoring",
    "inputSchema": {
      "type": "object",
      "properties": {
        "subAction": {
          "type": "string",
          "description": "Canonical manage_material sub-action to perform.",
          "enum": [
            "create_materials",
        ...
        "assetPaths": {
          "type": "array",
          "description": "List of asset paths for batch operations.",
          "items": {
            "type": "string"
          }
        },
        ...
        "parentMaterial": {
          "type": "string",
          "description": "Path to parent material for material instances."
        },
        "functionPath": {
          "type": "string",
        ...
        "localId": {
          "type": "string",
          "description": "Caller-supplied local node id used to refer to a node within a single batch payload (resolved against materialRootSentinel for top-level pins)."
        },
        "x": {
          "type": "number",
        ...
        "nodes": {
          "type": "array",
          "description": "Batch list of material node specs. Each item: { localId, nodeType|expressionClass, x, y, desc, ... }.",
          "items": {
            "type": "object"
          }
        },
        "connections": {
          "type": "array",
          "description": "Batch list of pin connections for add_material_nodes, update_material_nodes, and connect_material_pins. Each item: { fromNode, fromPin, fromOutputIndex, toNode, toPin }. connect_material_pins is batch-only and requires this array.",
          "items": {
            "type": "object"
          }
        },
        "updates": {
          "type": "array",
          "description": "Batch list of node-update specs for update_material_nodes and related update actions. update_material_nodes may also include top-level connections[] to reconnect pins in the same validated batch.",
          "items": {
            "type": "object"
          }
        },
        "identifiers": {
          "type": "array",
          "description": "Batch list of mixed-type expression identifiers (number index, string nodeId/guid, or {expressionPath, expressionIndex}). Used by find/get/remove and reset/clear parameter actions.",
          "items": {
            "type": "object"
          }
        },
        "items": {
          "type": "array",
          "description": "Generic batch items array used by plural actions whose payload shape varies per sub-action.",
          "items": {
            "type": "object"
          }
        },
        ...
        "inputs": {
          "type": "array",
          "description": "Batch list of function input or custom-expression input specs.",
          "items": {
            "type": "object"
          }
        },
        "outputs": {
          "type": "array",
          "description": "Batch list of function output or custom-expression additional output specs.",
          "items": {
            "type": "object"
          }
        },
        "filter": {
          "type": "string",
          "description": "Free-text filter string for find_material_expressions / list_material_expression_classes."
        },
        "category": {
          "type": "string",
          "description": "Category name filter (list_material_expression_classes)."
        },
        "parameterName": {
          "type": "string",
          "description": "Name of the parameter."
        ...
        "parameterGroup": {
          "type": "string",
          "description": "Parameter group name filter."
        },
        "samplerType": {
          "type": "string",
        ...
        "referencesTexture": {
          "type": "string",
          "description": "Find expressions that reference this texture path."
        },
        "expressionName": {
          "type": "string",
          "description": "Material expression object name filter."
        },
        "desc": {
          "type": "string",
          "description": "Short label/identifier for nodes, comments, named reroutes."
        },
        "limit": {
          "type": "number",
          "description": "Maximum number of results (paginated find/list)."
        },
        "offset": {
          "type": "number",
          "description": "Skip this many results before returning (paginated)."
        },
        "includeDetails": {
          "type": "boolean",
          "description": "Include detailed expression properties in find results."
        },
        "includeConnections": {
          "type": "boolean",
          "description": "Include pin connections in get_materials_info / find_material_expressions output."
        },
        "includeConsumers": {
          "type": "boolean",
          "description": "Include downstream consumers in expression diagnostics."
        },
        "isOrphan": {
          "type": "boolean",
          "description": "Filter to expressions that have no graph consumers."
        },
        "nodeType": {
          "type": "string",
        ...
        "expressionClass": {
          "type": "string",
          "description": "Fully-qualified material expression class name."
        },
        "nodeId": {
          "type": "string",
          "description": "ID of the node."
        ...
        "code": {
          "type": "string",
          "description": "HLSL source code for add_custom_expressions / update_custom_expressions."
        },
        "additionalDefines": {
          "type": "array",
          "description": "Custom expression #define entries.",
          "items": {
            "type": "string"
          }
        },
        ...
        "outputType": {
          "type": "string",
          "description": "Output type for custom expression / function output.",
          "enum": [
            "Float1",
            "Float2",
            "Float3",
        ...
        "onPinRemoved": {
          "type": "string",
          "description": "Behavior when an update removes a pin: 'break' to drop existing connections, 'preserve' to keep them where possible.",
          "enum": [
            "break",
            "preserve"
          ]
        ...
        "worldPositionShaderOffset": {
          "type": "string",
          "description": "World-position-offset shader behavior toggle.",
          "enum": [
            "Default",
            "ExcludeFromMain"
          ]
        ...
        "comment": {
          "type": "string",
          "description": "Comment text body for create_material_comments / wrap_material_nodes_in_comments."
        },
        "padding": {
          "type": "number",
        ...
        "minDistance": {
          "type": "number",
          "description": "Minimum connection distance for replace_long_connections_with_named_reroutes."
        },
        "operation": {
          "type": "string",
          "description": "Alignment / distribution operation for align_material_nodes."
        },
        "value": {
          "type": "object",
          "description": "Polymorphic value: number for scalar setters, {r,g,b,a} object for vector setters, asset path string for texture setters, bool for static-switch setters.",
          "additionalProperties": true
        },
        "defaultValue": {
          "type": "object",
          "description": "Default value for parameter / function input.",
          "additionalProperties": true
        },
        "previewValue": {
          "type": "object",
        ...
        "parameter": {
          "type": "object",
          "description": "Material parameter identity: name, type, association, index.",
          "additionalProperties": true
        },
        "channelNames": {
          "type": "object",
        ...
        "layerName": {
          "type": "string",
          "description": "Name of the landscape layer."
        },
        "blendType": {
          "type": "string",
        ...
        "layers": {
          "type": "array",
          "description": "Array of landscape layer configurations.",
          "items": {
            "type": "object"
          }
        },
        ...
        "timeoutSeconds": {
          "type": "number",
          "description": "Compile poll timeout in seconds for compile_materials / compile_materials_diagnostics."
        },
        "materialRootSentinel": {
          "type": "string",
          "description": "Informational sentinel localId returned in batch responses to identify the material's root pin set when resolving connections that target main material pins."
        }
      },
      "required": [
        "subAction"
