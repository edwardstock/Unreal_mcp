  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "connections": {
          "type": "array",
          "description": "Batch list of pin connections. Each item: { fromNode, fromPin, fromOutputIndex, toNode, toPin }.",
          "items": {
            "type": "object"
          }
        },
        "updates": {
          "type": "array",
          "description": "Batch list of node-update specs (per-node property overrides for update_material_nodes / update_material_function_calls / update_custom_expressions / update_function_inputs / update_function_outputs).",
          "items": {
            "type": "object"
          }
        },
