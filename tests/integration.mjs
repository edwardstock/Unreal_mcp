...
const testCases = [
  ...
  { scenario: 'Material: Create material', toolName: 'manage_material', arguments: { action: 'create_material', name: 'M_AdvTest', path: ADV_TEST_FOLDER }, expected: 'success|already exists' },
